...
DROP VIEW "SYSTEM"."CATEGORYVIEW";
DROP VIEW "SYSTEM"."CATEGORYVIEW1";
DROP VIEW "SYSTEM"."HUECOS_PENDIENTES_BLOQUEADOSP";
...
DROP VIEW "SYSTEM"."UNIDADES_DISPONIBLES";
...
DROP TABLE "SYSTEM"."CATEGORIES1";
DROP TABLE "SYSTEM"."CATEGORIES12";
DROP TABLE "SYSTEM"."CLIENTES";
DROP TABLE "SYSTEM"."COSTOEXTRA_FABRICANTE";
DROP TABLE "SYSTEM"."COSTO_FABRICANTE";
...
DROP TABLE "SYSTEM"."ENCARGADOS";
DROP TABLE "SYSTEM"."EXTRAS";
DROP TABLE "SYSTEM"."FABRICANTES";
DROP TABLE "SYSTEM"."FACTURAS";
DROP TABLE "SYSTEM"."FACTURAS_DETALLE";
DROP TABLE "SYSTEM"."HELP";
DROP TABLE "SYSTEM"."HUECOS";
...
DROP TABLE "SYSTEM"."VEHI_CAMBIO";
DROP TABLE "SYSTEM"."VEHICULOS";
DROP TABLE "SYSTEM"."VENDEDORES";
DROP SEQUENCE "SYSTEM"."CLIENTES_SEQUENCE";
DROP SEQUENCE "SYSTEM"."COSTOEXTRA_FABRICANTE_SEQUENCE";
DROP SEQUENCE "SYSTEM"."COSTO_FABRICANTE_SEQUENCE";
DROP SEQUENCE "SYSTEM"."EXTRAS_SEQUENCE";
DROP SEQUENCE "SYSTEM"."FABRICANTES_SEQUENCE";
DROP SEQUENCE "SYSTEM"."FACTURAS_DETALLE_SEQUENCE";
DROP SEQUENCE "SYSTEM"."FACTURAS_SEQUENCE";
...
DROP SEQUENCE "SYSTEM"."VEHI_CAMBIO_SEQUENCE";
DROP SEQUENCE "SYSTEM"."VEHICULOS_SEQUENCE";
DROP SEQUENCE "SYSTEM"."VENDEDORES_SEQUENCE";
DROP PROCEDURE "SYSTEM"."ORA$_SYS_REP_AUTH";
DROP PROCEDURE "SYSTEM"."REORDENAR_UNIDADES_EXTRAS";
DROP PACKAGE BODY "SYSTEM"."DBMS_REPCAT_AUTH";
DROP PACKAGE "SYSTEM"."DBMS_REPCAT_AUTH";
DROP FUNCTION "SYSTEM"."CELSIUS2FAHRENHEIT";
DROP FUNCTION "SYSTEM"."DECIMAL_BINARIO";
DROP FUNCTION "SYSTEM"."FINDMAX";
DROP FUNCTION "SYSTEM"."FINDMIN";
DROP FUNCTION "SYSTEM"."HELLO";
DROP FUNCTION "SYSTEM"."PRIMO";
...
--------------------------------------------------------
--  DDL for View CATEGORYVIEW
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "SYSTEM"."CATEGORYVIEW" ("NAME", "SEASON") AS 
  SELECT NAME, SEASON
  FROM CATEGORIES12
  WHERE SEASON='WINTER';
--------------------------------------------------------
--  DDL for View CATEGORYVIEW1
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "SYSTEM"."CATEGORYVIEW1" ("NAME", "SEASON") AS 
  SELECT NAME, SEASON
  FROM CATEGORIES12
  WHERE SEASON='WINTER';
--------------------------------------------------------
--  DDL for View HUECOS_PENDIENTES_BLOQUEADOSP
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "SYSTEM"."HUECOS_PENDIENTES_BLOQUEADOSP" ("ID", "ESTADO", "LATITUD", "LONGITUD", "ENCARGADO_ID", "FECHA_INGRESO") AS 
  SELECT HUECOS.ID, HUECOS.ESTADO, HUECOS.LATITUD, HUECOS.LONGITUD, HUECOS.ENCARGADO_ID, ENCARGADOS.FECHA_INGRESO
  FROM HUECOS 
  INNER JOIN ENCARGADOS ON ENCARGADOS.ID= HUECOS.ENCARGADO_ID WHERE (HUECOS.ESTADO='PENDIENTE' OR HUECOS.ESTADO = 'BLOQUEADO') AND
  ENCARGADOS.FECHA_INGRESO > TO_DATE('31/12/2013', 'DD/MM/YYYY');
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for View UNIDADES_DISPONIBLES
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "SYSTEM"."UNIDADES_DISPONIBLES" ("ID", "CODEXTRA", "CEDULA_CIUDADANIA", "NOMBRE") AS 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."CATEGORIES" 
   (	"ID_CATEGORIES" NUMBER, 
	...
	"SEASON" VARCHAR2(55 BYTE)
   ) ;
--------------------------------------------------------
--  DDL for Table CATEGORIES1
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."CATEGORIES1" 
   (	"ID_CATEGORIES" NUMBER, 
	"NAME" VARCHAR2(55 BYTE), 
	"SEASON" VARCHAR2(55 BYTE)
   ) ;
--------------------------------------------------------
--  DDL for Table CATEGORIES12
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."CATEGORIES12" 
   (	"ID_CATEGORIES" NUMBER, 
	"NAME" VARCHAR2(55 BYTE), 
	"SEASON" VARCHAR2(55 BYTE)
   ) ;
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."CLIENTES" 
   (	"ID" NUMBER, 
	"CEDULA_CIUDADANIA" VARCHAR2(15 BYTE), 
	"NOMBRE" VARCHAR2(100 BYTE), 
	"DIRECCION" VARCHAR2(60 BYTE), 
	"TELEFONO" VARCHAR2(30 BYTE)
   ) ;
  GRANT DELETE, INSERT, SELECT, UPDATE ON "SYSTEM"."CLIENTES" TO "DBAUSER";
--------------------------------------------------------
--  DDL for Table COSTOEXTRA_FABRICANTE
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."COSTOEXTRA_FABRICANTE" 
   (	"ID" NUMBER(38,0), 
	"IDEXTRA" NUMBER, 
	"IDFABRICANTE" NUMBER, 
	"COSTO" NUMBER(12,2)
   ) ;
  GRANT DELETE, INSERT, SELECT, UPDATE ON "SYSTEM"."COSTOEXTRA_FABRICANTE" TO "DBAUSER";
--------------------------------------------------------
--  DDL for Table COSTO_FABRICANTE
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."COSTO_FABRICANTE" 
   (	"ID" NUMBER, 
	"IDVEHICULO" NUMBER, 
	"IDFABRICANTE" NUMBER, 
	"COSTO" NUMBER(12,2)
   ) ;
  GRANT DELETE, INSERT, SELECT, UPDATE ON "SYSTEM"."COSTO_FABRICANTE" TO "DBAUSER";
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Table ENCARGADOS
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."ENCARGADOS" 
   (	"ID" NUMBER, 
	"NOMBRES" VARCHAR2(255 BYTE) DEFAULT NULL, 
	"APELLIDOS" VARCHAR2(255 BYTE) DEFAULT NULL, 
	"CODIGO_INTERNO" VARCHAR2(36 BYTE), 
	"FECHA_INGRESO" DATE
   ) ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."EXTRAS" 
   (	"ID" NUMBER, 
	"CODEXTRA" VARCHAR2(15 BYTE), 
	"DESCRIPCION" VARCHAR2(100 BYTE), 
	"COSTO_VENTA" NUMBER(12,2), 
	"UNIDADES_DISPONIBLES" NUMBER DEFAULT 30
   ) ;
  GRANT DELETE, INSERT, SELECT, UPDATE ON "SYSTEM"."EXTRAS" TO "DBAUSER";
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  GRANT DELETE, INSERT, SELECT, UPDATE ON "SYSTEM"."FABRICANTES" TO "DBAUSER";
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."FACTURAS" 
   (	"ID" NUMBER, 
	"NUM_FACTURA" VARCHAR2(10 BYTE), 
	"FECHA_FACTURA" DATE, 
	"IMPUESTOS" NUMBER(12,2), 
	"TARIFAS_LICENCIA" NUMBER(12,2), 
  ...
  GRANT DELETE, INSERT, SELECT, UPDATE ON "SYSTEM"."FACTURAS" TO "DBAUSER";
--------------------------------------------------------
--  DDL for Table FACTURAS_DETALLE
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."FACTURAS_DETALLE" 
   (	"ID" NUMBER, 
	"IDFACTURA" NUMBER, 
	"IDEXTRA" NUMBER, 
	"COSTO_TOTAL" NUMBER(12,2), 
	"FIRMA" VARCHAR2(50 BYTE), 
	"IDVEHICULO" NUMBER, 
	"IDVEHICAMBIO" NUMBER
   ) ;
  GRANT DELETE, INSERT, SELECT, UPDATE ON "SYSTEM"."FACTURAS_DETALLE" TO "DBAUSER";
--------------------------------------------------------
--  DDL for Table HELP
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."HUECOS" 
   (	"ID" NUMBER, 
	"ESTADO" VARCHAR2(255 BYTE) DEFAULT NULL, 
	"ENCARGADO_ID" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."PRODUCTS" 
   (	"ID_PRODUCTS" NUMBER, 
	"NAME" VARCHAR2(55 BYTE), 
	"REFERENCE" VARCHAR2(55 BYTE), 
	"PRICE" NUMBER(10,3), 
	"CATEGORY_ID" NUMBER
   ) ;
--------------------------------------------------------
--  DDL for Table PRODUCTS1
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."PRODUCTS1" 
   (	"ID_PRODUCTS" NUMBER, 
	"NAME" VARCHAR2(55 BYTE), 
	"REFERENCE" VARCHAR2(55 BYTE), 
	"PRICE" NUMBER(10,3), 
...
--------------------------------------------------------
--  DDL for Table VEHI_CAMBIO
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."VEHI_CAMBIO" 
   (	"ID" NUMBER, 
	"NUM_SERIAL" VARCHAR2(15 BYTE), 
	"HECHURA" VARCHAR2(100 BYTE), 
	"MODELO" VARCHAR2(50 BYTE), 
	"ANO" NUMBER(4,0), 
	"COSTO_PERMITIDO" NUMBER(12,2)
   ) ;
  GRANT DELETE, INSERT, SELECT, UPDATE ON "SYSTEM"."VEHI_CAMBIO" TO "DBAUSER";
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."VEHICULOS" 
   (	"ID" NUMBER, 
	"VIN" VARCHAR2(15 BYTE), 
	"NOMBRE" VARCHAR2(100 BYTE), 
	"MODELO" VARCHAR2(60 BYTE), 
	"ANO" NUMBER(4,0), 
	"ESTADO" VARCHAR2(10 BYTE)
   ) ;
  GRANT DELETE, INSERT, SELECT, UPDATE ON "SYSTEM"."VEHICULOS" TO "DBAUSER";
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  GRANT DELETE, INSERT, SELECT, UPDATE ON "SYSTEM"."VENDEDORES" TO "DBAUSER";
--------------------------------------------------------
--  DDL for Sequence CLIENTES_SEQUENCE
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."CLIENTES_SEQUENCE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence COSTOEXTRA_FABRICANTE_SEQUENCE
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."COSTOEXTRA_FABRICANTE_SEQUENCE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence COSTO_FABRICANTE_SEQUENCE
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."COSTO_FABRICANTE_SEQUENCE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence EXTRAS_SEQUENCE
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."EXTRAS_SEQUENCE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence FABRICANTES_SEQUENCE
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."FABRICANTES_SEQUENCE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence FACTURAS_DETALLE_SEQUENCE
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."FACTURAS_DETALLE_SEQUENCE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence FACTURAS_SEQUENCE
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."FACTURAS_SEQUENCE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Sequence VEHI_CAMBIO_SEQUENCE
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."VEHI_CAMBIO_SEQUENCE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence VEHICULOS_SEQUENCE
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."VEHICULOS_SEQUENCE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence VENDEDORES_SEQUENCE
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."VENDEDORES_SEQUENCE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
REM INSERTING into SYSTEM.ANSWERS
SET DEFINE OFF;
Insert into SYSTEM.ANSWERS (ID_ANSWERS,NUMBER_OF_QUESTION,ANSWER) values ('1','1','1');
Insert into SYSTEM.ANSWERS (ID_ANSWERS,NUMBER_OF_QUESTION,ANSWER) values ('2','2','963');
Insert into SYSTEM.ANSWERS (ID_ANSWERS,NUMBER_OF_QUESTION,ANSWER) values ('3','3','8C402EDA-D7D5-540D-3974-4EB9C810E3D6');
Insert into SYSTEM.ANSWERS (ID_ANSWERS,NUMBER_OF_QUESTION,ANSWER) values ('4','4','THERE IS NO PRODUCT WITH THAT REFERENCE');
Insert into SYSTEM.ANSWERS (ID_ANSWERS,NUMBER_OF_QUESTION,ANSWER) values ('5','5','THERE IS NO CATEGORY NAME BELONGING TO A PRODUCT NAMED NULLA EGET');
...
SET DEFINE OFF;
Insert into SYSTEM.CATEGORIES (ID_CATEGORIES,NAME,SEASON) values ('1','shoes','winter');
Insert into SYSTEM.CATEGORIES (ID_CATEGORIES,NAME,SEASON) values ('2','shoes','summer');
Insert into SYSTEM.CATEGORIES (ID_CATEGORIES,NAME,SEASON) values ('3','swim wear','summer');
Insert into SYSTEM.CATEGORIES (ID_CATEGORIES,NAME,SEASON) values ('4','tennis','summer');
Insert into SYSTEM.CATEGORIES (ID_CATEGORIES,NAME,SEASON) values ('5','ski','winter');
Insert into SYSTEM.CATEGORIES (ID_CATEGORIES,NAME,SEASON) values ('6','snowboard','winter');
Insert into SYSTEM.CATEGORIES (ID_CATEGORIES,NAME,SEASON) values ('7','golf','summer');
Insert into SYSTEM.CATEGORIES (ID_CATEGORIES,NAME,SEASON) values ('8','diving equipment','summer');
Insert into SYSTEM.CATEGORIES (ID_CATEGORIES,NAME,SEASON) values ('9','running wear','summer');
Insert into SYSTEM.CATEGORIES (ID_CATEGORIES,NAME,SEASON) values ('10','fitness gear','summer');
Insert into SYSTEM.CATEGORIES (ID_CATEGORIES,NAME,SEASON) values ('11','fitness gear','winter');
REM INSERTING into SYSTEM.CATEGORIES1
SET DEFINE OFF;
Insert into SYSTEM.CATEGORIES1 (ID_CATEGORIES,NAME,SEASON) values ('1','shoes','WINTER');
Insert into SYSTEM.CATEGORIES1 (ID_CATEGORIES,NAME,SEASON) values ('2','shoes','SUMMER');
Insert into SYSTEM.CATEGORIES1 (ID_CATEGORIES,NAME,SEASON) values ('3','swim wear','SUMMER');
Insert into SYSTEM.CATEGORIES1 (ID_CATEGORIES,NAME,SEASON) values ('4','tennis','SUMMER');
Insert into SYSTEM.CATEGORIES1 (ID_CATEGORIES,NAME,SEASON) values ('5','ski','WINTER');
Insert into SYSTEM.CATEGORIES1 (ID_CATEGORIES,NAME,SEASON) values ('6','snowboard','WINTER');
Insert into SYSTEM.CATEGORIES1 (ID_CATEGORIES,NAME,SEASON) values ('7','golf','SUMMER');
Insert into SYSTEM.CATEGORIES1 (ID_CATEGORIES,NAME,SEASON) values ('8','diving equipment','SUMMER');
Insert into SYSTEM.CATEGORIES1 (ID_CATEGORIES,NAME,SEASON) values ('9','running wear','SUMMER');
Insert into SYSTEM.CATEGORIES1 (ID_CATEGORIES,NAME,SEASON) values ('10','fitness gear','SUMMER');
Insert into SYSTEM.CATEGORIES1 (ID_CATEGORIES,NAME,SEASON) values ('11','fitness gear','WINTER');
REM INSERTING into SYSTEM.CATEGORIES12
SET DEFINE OFF;
Insert into SYSTEM.CATEGORIES12 (ID_CATEGORIES,NAME,SEASON) values ('1','ANYWHERE','WINTER');
Insert into SYSTEM.CATEGORIES12 (ID_CATEGORIES,NAME,SEASON) values ('2','ANYWHERE','SUMMER');
REM INSERTING into SYSTEM.CLIENTES
SET DEFINE OFF;
REM INSERTING into SYSTEM.COSTOEXTRA_FABRICANTE
SET DEFINE OFF;
REM INSERTING into SYSTEM.COSTO_FABRICANTE
SET DEFINE OFF;
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.ENCARGADOS
SET DEFINE OFF;
Insert into SYSTEM.ENCARGADOS (ID,NOMBRES,APELLIDOS,CODIGO_INTERNO,FECHA_INGRESO) values ('2','Chaney','Rodriquez','94E30F4A-4A0B-6D36-37DE-5F0C14E16B03',to_date('23/11/03','DD/MM/RR'));
Insert into SYSTEM.ENCARGADOS (ID,NOMBRES,APELLIDOS,CODIGO_INTERNO,FECHA_INGRESO) values ('5','Germane','Paul','2B13C925-C483-A1EC-E6A5-669A086BF345',to_date('17/05/17','DD/MM/RR'));
Insert into SYSTEM.ENCARGADOS (ID,NOMBRES,APELLIDOS,CODIGO_INTERNO,FECHA_INGRESO) values ('7','Marny','Greene','9795F33D-D6DF-A7FA-BCA9-BA311A6F24AC',to_date('16/10/07','DD/MM/RR'));
Insert into SYSTEM.ENCARGADOS (ID,NOMBRES,APELLIDOS,CODIGO_INTERNO,FECHA_INGRESO) values ('8','Austin','Sweeney','99304377-BBA9-AECC-16EE-B52CA7E0539D',to_date('11/06/07','DD/MM/RR'));
Insert into SYSTEM.ENCARGADOS (ID,NOMBRES,APELLIDOS,CODIGO_INTERNO,FECHA_INGRESO) values ('9','Kevin','Thomas','E8B52EEB-73A8-D85C-0C09-D4FCDA50D435',to_date('17/10/05','DD/MM/RR'));
Insert into SYSTEM.ENCARGADOS (ID,NOMBRES,APELLIDOS,CODIGO_INTERNO,FECHA_INGRESO) values ('12','Ria','Boyd','9B0B2454-F055-DC58-590A-49A263AF1740',to_date('01/06/16','DD/MM/RR'));
Insert into SYSTEM.ENCARGADOS (ID,NOMBRES,APELLIDOS,CODIGO_INTERNO,FECHA_INGRESO) values ('14','Madeline','Gonzales','B3379E8F-B25B-8051-EFC9-D5EC47350134',to_date('24/05/09','DD/MM/RR'));
Insert into SYSTEM.ENCARGADOS (ID,NOMBRES,APELLIDOS,CODIGO_INTERNO,FECHA_INGRESO) values ('15','Joan','Bolton','B25A1086-D5C4-B56B-57C2-1C4C8EE482CD',to_date('06/11/11','DD/MM/RR'));
Insert into SYSTEM.ENCARGADOS (ID,NOMBRES,APELLIDOS,CODIGO_INTERNO,FECHA_INGRESO) values ('17','Clark','Chapman','DF00D6E3-6C96-4813-A06B-73FA128489F4',to_date('06/10/17','DD/MM/RR'));
Insert into SYSTEM.ENCARGADOS (ID,NOMBRES,APELLIDOS,CODIGO_INTERNO,FECHA_INGRESO) values ('19','Olga','Faulkner','FCA297FF-1E6D-0132-E9BB-FDB36787778F',to_date('19/05/08','DD/MM/RR'));
Insert into SYSTEM.ENCARGADOS (ID,NOMBRES,APELLIDOS,CODIGO_INTERNO,FECHA_INGRESO) values ('20','Tate','Garza','B3AA2CE5-0FE5-2B5C-89E3-652BD63D588D',to_date('07/03/13','DD/MM/RR'));
Insert into SYSTEM.ENCARGADOS (ID,NOMBRES,APELLIDOS,CODIGO_INTERNO,FECHA_INGRESO) values ('21','Joelle','Underwood','7C88B299-A93C-2D6D-83F4-A8A350EEAA62',to_date('07/07/11','DD/MM/RR'));
Insert into SYSTEM.ENCARGADOS (ID,NOMBRES,APELLIDOS,CODIGO_INTERNO,FECHA_INGRESO) values ('22','Callie','Wilkerson','3BEC5BB4-4496-6963-ED87-02E72894C56A',to_date('29/03/15','DD/MM/RR'));
Insert into SYSTEM.ENCARGADOS (ID,NOMBRES,APELLIDOS,CODIGO_INTERNO,FECHA_INGRESO) values ('23','Rhiannon','Hahn','4974DD8D-6B0A-72C1-B870-0B5EADF2044C',to_date('27/09/07','DD/MM/RR'));
Insert into SYSTEM.ENCARGADOS (ID,NOMBRES,APELLIDOS,CODIGO_INTERNO,FECHA_INGRESO) values ('24','Ulysses','Morris','8E62D2FC-2E6A-A708-F15D-1B0C4A56780D',to_date('24/11/08','DD/MM/RR'));
Insert into SYSTEM.ENCARGADOS (ID,NOMBRES,APELLIDOS,CODIGO_INTERNO,FECHA_INGRESO) values ('27','Fulton','Parks','8FAC248F-CF10-3ACF-A47F-C3B3A467C6C5',to_date('27/09/10','DD/MM/RR'));
Insert into SYSTEM.ENCARGADOS (ID,NOMBRES,APELLIDOS,CODIGO_INTERNO,FECHA_INGRESO) values ('28','Len','Tate','31C4383E-E76A-0B27-13F4-B81ADDB2DAD0',to_date('12/02/11','DD/MM/RR'));
Insert into SYSTEM.ENCARGADOS (ID,NOMBRES,APELLIDOS,CODIGO_INTERNO,FECHA_INGRESO) values ('30','Myra','Mcmillan','DB863E23-B479-2197-F4C5-7B5F8B7E9E6F',to_date('22/03/08','DD/MM/RR'));
Insert into SYSTEM.ENCARGADOS (ID,NOMBRES,APELLIDOS,CODIGO_INTERNO,FECHA_INGRESO) values ('31','Rebecca','Berger','6FA2FBC5-B6D0-D579-FC83-9EAD52FF1844',to_date('16/07/12','DD/MM/RR'));
Insert into SYSTEM.ENCARGADOS (ID,NOMBRES,APELLIDOS,CODIGO_INTERNO,FECHA_INGRESO) values ('32','Montana','Jefferson','22AACDFB-C979-0E32-6882-0133EB79EAC1',to_date('29/06/02','DD/MM/RR'));
Insert into SYSTEM.ENCARGADOS (ID,NOMBRES,APELLIDOS,CODIGO_INTERNO,FECHA_INGRESO) values ('33','John','Lara','D8044B2A-6AAE-C1CE-3EB0-0EDA9337453B',to_date('22/05/15','DD/MM/RR'));
Insert into SYSTEM.ENCARGADOS (ID,NOMBRES,APELLIDOS,CODIGO_INTERNO,FECHA_INGRESO) values ('34','Carlos','Mcbride','047099A6-E915-59AA-DE2E-522272101A29',to_date('12/11/11','DD/MM/RR'));
Insert into SYSTEM.ENCARGADOS (ID,NOMBRES,APELLIDOS,CODIGO_INTERNO,FECHA_INGRESO) values ('35','Rana','Dorsey','19005621-B125-E646-FB8B-A2383C3E2533',to_date('04/11/12','DD/MM/RR'));
Insert into SYSTEM.ENCARGADOS (ID,NOMBRES,APELLIDOS,CODIGO_INTERNO,FECHA_INGRESO) values ('37','Kelly','Newman','2EFAE916-40D9-361C-01E9-467828342C99',to_date('27/10/14','DD/MM/RR'));
Insert into SYSTEM.ENCARGADOS (ID,NOMBRES,APELLIDOS,CODIGO_INTERNO,FECHA_INGRESO) values ('40','Aline','Bradford','00314BFF-AEEA-1480-8AB6-0E0BE35AA8F3',to_date('20/07/01','DD/MM/RR'));
Insert into SYSTEM.ENCARGADOS (ID,NOMBRES,APELLIDOS,CODIGO_INTERNO,FECHA_INGRESO) values ('41','Camden','Tillman','9A2CE596-C87F-56F8-35B0-153F7184486C',to_date('12/09/11','DD/MM/RR'));
Insert into SYSTEM.ENCARGADOS (ID,NOMBRES,APELLIDOS,CODIGO_INTERNO,FECHA_INGRESO) values ('42','Ralph','Owen','4067A30B-048F-2F45-B058-9390CC06976B',to_date('17/06/17','DD/MM/RR'));
Insert into SYSTEM.ENCARGADOS (ID,NOMBRES,APELLIDOS,CODIGO_INTERNO,FECHA_INGRESO) values ('44','Blake','Miller','DF29FC1D-E79D-BB91-9769-2DF90472F69A',to_date('12/05/12','DD/MM/RR'));
Insert into SYSTEM.ENCARGADOS (ID,NOMBRES,APELLIDOS,CODIGO_INTERNO,FECHA_INGRESO) values ('47','Zia','Austin','87BB9715-9B0E-9646-8F64-313A4F398427',to_date('09/11/15','DD/MM/RR'));
Insert into SYSTEM.ENCARGADOS (ID,NOMBRES,APELLIDOS,CODIGO_INTERNO,FECHA_INGRESO) values ('48','Dieter','Larson','AF42FED2-F0E6-40A6-B8B2-4854D9027DD4',to_date('22/11/07','DD/MM/RR'));
Insert into SYSTEM.ENCARGADOS (ID,NOMBRES,APELLIDOS,CODIGO_INTERNO,FECHA_INGRESO) values ('50','Emmanuel','Bartlett','105D749C-9447-7D36-39C9-79EFC029DB77',to_date('18/05/07','DD/MM/RR'));
REM INSERTING into SYSTEM.EXTRAS
SET DEFINE OFF;
REM INSERTING into SYSTEM.FABRICANTES
SET DEFINE OFF;
REM INSERTING into SYSTEM.FACTURAS
SET DEFINE OFF;
REM INSERTING into SYSTEM.FACTURAS_DETALLE
SET DEFINE OFF;
...
REM INSERTING into SYSTEM.HUECOS
SET DEFINE OFF;
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('100','BLOQUEADO','3','6.27797053','-75.59977158');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('101','ACTIVO','9','6.25350282','-75.53799123');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('102','ACTIVO','1','6.21940204','-75.54737441');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('103','ESTUDIO','10','6.27560743','-75.6061934');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('104','SOLUCIONADO','10','6.21995743','-75.55323217');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('105','PENDIENTE','10','6.2185099','-75.59948572');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('106','BLOQUEADO','6','6.21800965','-75.57281036');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('107','ESTUDIO','10','6.24612684','-75.54472849');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('108','ACTIVO','6','6.28492392','-75.59065174');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('109','ACTIVO','9','6.28259514','-75.57923706');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('110','BLOQUEADO','8','6.23178642','-75.55353016');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('111','ACTIVO','1','6.27513255','-75.59870033');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('112','BLOQUEADO','3','6.28450889','-75.59460961');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('113','SOLUCIONADO','9','6.25431664','-75.5772978');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('114','PENDIENTE','9','6.23205875','-75.57711521');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('115','ACTIVO','8','6.26235835','-75.57796863');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('116','ESTUDIO','7','6.28496578','-75.59932254');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('117','BLOQUEADO','1','6.26913072','-75.56177009');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('118','SOLUCIONADO','6','6.23919107','-75.59553577');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('119','ESTUDIO','3','6.24729016','-75.55102513');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('120','BLOQUEADO','5','6.27014162','-75.60401744');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('121','BLOQUEADO','4','6.27605807','-75.57457095');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('122','PENDIENTE','3','6.22455318','-75.59091503');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('123','PENDIENTE','8','6.27111798','-75.57848184');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('124','ACTIVO','4','6.25268894','-75.55210594');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('125','SOLUCIONADO','7','6.26269606','-75.60468138');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('126','SOLUCIONADO','6','6.27986798','-75.56833306');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('127','SOLUCIONADO','4','6.23667729','-75.62009619');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('128','SOLUCIONADO','10','6.21946567','-75.5766914');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('129','BLOQUEADO','7','6.21983521','-75.56318837');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('130','SOLUCIONADO','9','6.22272303','-75.61061437');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('131','ESTUDIO','4','6.23830713','-75.55687666');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('132','ESTUDIO','1','6.22823744','-75.58674503');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('133','ACTIVO','4','6.24568678','-75.57988537');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('134','SOLUCIONADO','1','6.27840675','-75.55235601');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('135','ESTUDIO','8','6.27641943','-75.56681409');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('136','BLOQUEADO','6','6.24403161','-75.58123194');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('137','PENDIENTE','4','6.25936221','-75.58879066');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('138','BLOQUEADO','8','6.23841419','-75.56405689');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('139','PENDIENTE','8','6.23138307','-75.54857299');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('140','SOLUCIONADO','6','6.25415031','-75.53812174');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('141','ESTUDIO','4','6.27079214','-75.5760141');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('142','PENDIENTE','9','6.22401568','-75.55641978');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('143','ESTUDIO','2','6.25449778','-75.58023215');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('144','PENDIENTE','5','6.28347678','-75.59261805');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('145','ESTUDIO','1','6.22228125','-75.54821211');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('146','SOLUCIONADO','5','6.23099557','-75.60847566');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('147','BLOQUEADO','8','6.25340171','-75.56182169');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('148','SOLUCIONADO','6','6.25997477','-75.57862814');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('149','ESTUDIO','4','6.22466756','-75.61107187');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('150','ACTIVO','10','6.23809613','-75.59879066');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('151','ACTIVO','2','6.23575131','-75.57961162');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('152','PENDIENTE','10','6.25986896','-75.5802138');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('153','PENDIENTE','10','6.22121476','-75.5546801');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('154','PENDIENTE','4','6.28552861','-75.57813516');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('155','SOLUCIONADO','7','6.23765812','-75.5669787');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('156','PENDIENTE','9','6.25644943','-75.56619857');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('157','SOLUCIONADO','7','6.20306007','-75.58879137');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('158','BLOQUEADO','4','6.25808801','-75.59591239');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('159','ACTIVO','5','6.24883505','-75.6130745');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('160','SOLUCIONADO','10','6.27792123','-75.59751084');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('161','PENDIENTE','7','6.26343898','-75.54563305');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('162','PENDIENTE','4','6.24267002','-75.58893151');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('163','BLOQUEADO','8','6.24043353','-75.54554598');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('164','SOLUCIONADO','8','6.22342849','-75.60812494');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('165','PENDIENTE','10','6.23346858','-75.55832889');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('166','ESTUDIO','8','6.24954249','-75.60848948');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('167','ACTIVO','10','6.20550853','-75.60390934');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('168','ACTIVO','5','6.20486188','-75.57037313');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('169','ESTUDIO','9','6.21435655','-75.60069893');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('170','ACTIVO','4','6.24327472','-75.62340707');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('171','SOLUCIONADO','5','6.21884194','-75.59782135');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('172','BLOQUEADO','9','6.2378014','-75.61946892');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('173','PENDIENTE','10','6.22349646','-75.61453198');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('174','ESTUDIO','7','6.27019944','-75.56009929');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('175','ACTIVO','10','6.21883145','-75.57408797');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('176','ACTIVO','5','6.26630782','-75.59785071');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('177','SOLUCIONADO','5','6.23745446','-75.60127606');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('178','PENDIENTE','8','6.20973628','-75.58881779');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('179','BLOQUEADO','5','6.21920566','-75.55810129');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('180','ACTIVO','9','6.26478998','-75.59416208');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('181','PENDIENTE','2','6.23106636','-75.60975925');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('182','PENDIENTE','9','6.26410436','-75.55831429');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('183','SOLUCIONADO','1','6.23723206','-75.62178369');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('184','BLOQUEADO','7','6.24924303','-75.61814873');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('185','SOLUCIONADO','9','6.27408314','-75.57444827');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('186','BLOQUEADO','5','6.24901784','-75.53877617');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('187','SOLUCIONADO','4','6.25220065','-75.62164707');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('188','BLOQUEADO','3','6.20792835','-75.59502119');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('189','BLOQUEADO','4','6.22283406','-75.58601521');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('190','ESTUDIO','10','6.28490171','-75.56462964');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('191','ACTIVO','7','6.24868378','-75.62593906');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('192','BLOQUEADO','9','6.20657865','-75.56809787');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('193','SOLUCIONADO','7','6.23290839','-75.59572791');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('194','BLOQUEADO','4','6.21410593','-75.6145993');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('195','ACTIVO','5','6.26895924','-75.57009012');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('196','ACTIVO','2','6.26351918','-75.56153674');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('197','SOLUCIONADO','3','6.26240196','-75.55383973');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('198','SOLUCIONADO','1','6.24451469','-75.62451972');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('199','SOLUCIONADO','4','6.26920821','-75.56076384');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('200','SOLUCIONADO','5','6.26235697','-75.55464054');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('201','BLOQUEADO','2','6.20697345','-75.57964192');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('202','BLOQUEADO','5','6.26117254','-75.59133276');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('203','ESTUDIO','6','6.26687843','-75.55604729');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('204','BLOQUEADO','9','6.25585154','-75.62227353');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('205','ESTUDIO','4','6.23846758','-75.60481342');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('206','ACTIVO','5','6.20304017','-75.57210677');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('207','ESTUDIO','9','6.25648739','-75.54658534');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('208','BLOQUEADO','9','6.22345017','-75.55368613');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('209','SOLUCIONADO','7','6.20862238','-75.57636722');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('210','ACTIVO','9','6.25884149','-75.62271281');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('211','PENDIENTE','10','6.23120599','-75.58757466');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('212','PENDIENTE','3','6.2537321','-75.5378909');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('213','SOLUCIONADO','7','6.20306625','-75.57589074');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('214','SOLUCIONADO','10','6.26311951','-75.61754225');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('215','SOLUCIONADO','5','6.27192764','-75.61650207');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('216','ESTUDIO','6','6.24046149','-75.61799187');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('217','SOLUCIONADO','10','6.23691683','-75.59582882');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('218','BLOQUEADO','3','6.21231685','-75.57363264');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('219','ACTIVO','3','6.25337995','-75.61890767');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('220','BLOQUEADO','9','6.27570553','-75.60766757');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('221','BLOQUEADO','9','6.20255238','-75.57321222');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('222','ESTUDIO','3','6.22456259','-75.54714951');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('223','BLOQUEADO','4','6.27941689','-75.5612512');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('224','ACTIVO','2','6.21973166','-75.59092939');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('225','ACTIVO','3','6.28264206','-75.60191532');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('226','SOLUCIONADO','1','6.23808494','-75.5931726');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('227','ACTIVO','1','6.26544861','-75.59469641');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('228','PENDIENTE','1','6.25695773','-75.61074754');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('229','ACTIVO','3','6.24965843','-75.56417663');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('230','BLOQUEADO','6','6.2395179','-75.60562885');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('231','SOLUCIONADO','1','6.22868196','-75.55161992');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('232','ESTUDIO','8','6.24296046','-75.5966596');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('233','PENDIENTE','7','6.26391902','-75.56159378');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('234','ESTUDIO','9','6.20732424','-75.5711477');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('235','SOLUCIONADO','3','6.27605979','-75.57182083');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('236','ACTIVO','5','6.20231876','-75.59549823');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('237','BLOQUEADO','10','6.24215824','-75.62018297');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('238','ACTIVO','7','6.24352699','-75.61189859');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('239','BLOQUEADO','10','6.75°33?21?W','-75');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('240','ESTUDIO','3','6.27499385','-75.55858639');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('241','SOLUCIONADO','7','6.20683931','-75.57082439');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('242','PENDIENTE','8','6.20845896','-75.55996108');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('243','BLOQUEADO','8','6.28365534','-75.59917692');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('244','SOLUCIONADO','1','6.22408705','-75.56837767');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('245','PENDIENTE','6','6.22169369','-75.56290284');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('246','SOLUCIONADO','8','6.23738717','-75.59116555');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('247','ACTIVO','8','6.23722591','-75.60134694');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('248','SOLUCIONADO','2','6.2615681','-75.59846562');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('249','ACTIVO','9','6.26385683','-75.56562401');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('250','ACTIVO','4','6.22169151','-75.60132414');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('251','ACTIVO','6','6.25774721','-75.53895088');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('252','SOLUCIONADO','8','6.27608599','-75.58901843');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('253','ACTIVO','2','6.20291197','-75.59024681');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('254','BLOQUEADO','3','6.23304019','-75.5405267');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('255','BLOQUEADO','4','6.20951999','-75.56607692');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('256','ESTUDIO','1','6.2645798','-75.57831857');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('257','BLOQUEADO','4','6.26968411','-75.54567527');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('258','PENDIENTE','3','6.21975773','-75.56835172');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('259','BLOQUEADO','2','6.214487','-75.59983537');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('260','ACTIVO','9','6.26319629','-75.56229229');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('261','PENDIENTE','9','6.25566842','-75.62225213');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('262','BLOQUEADO','3','6.22799038','-75.5868756');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('263','ESTUDIO','6','6.2691754','-75.6100191');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('264','ESTUDIO','5','6.28166342','-75.58954679');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('265','PENDIENTE','1','6.21744007','-75.55638788');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('266','ACTIVO','2','6.2244974','-75.6196477');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('267','SOLUCIONADO','1','6.25918943','-75.58474977');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('268','ACTIVO','7','6.27043442','-75.59167575');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('269','PENDIENTE','6','6.25288698','-75.59334807');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('270','ACTIVO','1','6.24852263','-75.5872123');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('271','SOLUCIONADO','9','6.26330765','-75.55128329');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('272','SOLUCIONADO','5','6.21822433','-75.6160282');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('273','SOLUCIONADO','8','6.20333744','-75.57089084');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('274','SOLUCIONADO','9','6.22079374','-75.59451448');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('275','BLOQUEADO','7','6.22973294','-75.61649377');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('276','ACTIVO','6','6.27888389','-75.58942742');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('277','SOLUCIONADO','9','6.21579314','-75.56100424');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('278','SOLUCIONADO','5','6.2445674','-75.59523637');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('279','ESTUDIO','4','6.24436192','-75.615986');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('280','ACTIVO','7','6.21371209','-75.60334339');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('281','ESTUDIO','4','6.26490967','-75.57311715');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('282','BLOQUEADO','9','6.24243875','-75.58727266');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('283','PENDIENTE','1','6.24809597','-75.62070677');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('284','PENDIENTE','1','6.2377022','-75.60440186');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('285','ESTUDIO','1','6.26113836','-75.55512497');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('286','BLOQUEADO','2','6.28721105','-75.5832165');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('287','BLOQUEADO','3','6.24331323','-75.60644486');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('288','BLOQUEADO','4','6.25710289','-75.59933039');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('289','PENDIENTE','4','6.2273069','-75.57221163');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('290','ACTIVO','2','6.27915696','-75.5833551');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('291','PENDIENTE','10','6.24733453','-75.59695222');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('292','SOLUCIONADO','6','6.23157455','-75.541421');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('293','ESTUDIO','10','6.20998001','-75.57910108');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('294','PENDIENTE','8','6.24022072','-75.58010948');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('295','ESTUDIO','10','6.24135146','-75.58784415');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('296','SOLUCIONADO','1','6.23339205','-75.57993873');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('297','BLOQUEADO','5','6.2183412','-75.60062209');
Insert into SYSTEM.HUECOS (ID,ESTADO,ENCARGADO_ID,LATITUD,LONGITUD) values ('298','BLOQUEADO','7','6.21406547','-75.57199669');
...
SET DEFINE OFF;
Insert into SYSTEM.PRODUCTS (ID_PRODUCTS,NAME,REFERENCE,PRICE,CATEGORY_ID) values ('1000','enim. Mauris','8C402EDA-D7D5-540D-3974-4EB9C810E3D6','10','5');
Insert into SYSTEM.PRODUCTS (ID_PRODUCTS,NAME,REFERENCE,PRICE,CATEGORY_ID) values ('1005','libero.','68D3F0AC-7061-112A-BD4B-AD1A8108156A','378','11');
Insert into SYSTEM.PRODUCTS (ID_PRODUCTS,NAME,REFERENCE,PRICE,CATEGORY_ID) values ('1010','fames ac turpis','47AF013F-1611-2695-F069-990726B02BCD','732','8');
Insert into SYSTEM.PRODUCTS (ID_PRODUCTS,NAME,REFERENCE,PRICE,CATEGORY_ID) values ('1015','fringilla.','AA3BECCF-1E18-EC21-0B0E-6E60D26E9515','878','4');
Insert into SYSTEM.PRODUCTS (ID_PRODUCTS,NAME,REFERENCE,PRICE,CATEGORY_ID) values ('1020','Phasellus','92AD2936-611E-08D8-F14C-C55F55D7448D','476','11');
Insert into SYSTEM.PRODUCTS (ID_PRODUCTS,NAME,REFERENCE,PRICE,CATEGORY_ID) values ('1250','ultrices','1F064187-E60B-C277-A1C6-1B9A7EDD2766','83','1');
REM INSERTING into SYSTEM.PRODUCTS1
SET DEFINE OFF;
Insert into SYSTEM.PRODUCTS1 (ID_PRODUCTS,NAME,REFERENCE,PRICE,CATEGORY_ID) values ('1000','enim. Mauris','8C402EDA-D7D5-540D-3974-4EB9C810E3D6','10','5');
Insert into SYSTEM.PRODUCTS1 (ID_PRODUCTS,NAME,REFERENCE,PRICE,CATEGORY_ID) values ('1005','libero.','68D3F0AC-7061-112A-BD4B-AD1A8108156A','378','11');
Insert into SYSTEM.PRODUCTS1 (ID_PRODUCTS,NAME,REFERENCE,PRICE,CATEGORY_ID) values ('1010','fames ac turpis','47AF013F-1611-2695-F069-990726B02BCD','732','8');
Insert into SYSTEM.PRODUCTS1 (ID_PRODUCTS,NAME,REFERENCE,PRICE,CATEGORY_ID) values ('1015','fringilla.','AA3BECCF-1E18-EC21-0B0E-6E60D26E9515','878','4');
Insert into SYSTEM.PRODUCTS1 (ID_PRODUCTS,NAME,REFERENCE,PRICE,CATEGORY_ID) values ('1020','Phasellus','92AD2936-611E-08D8-F14C-C55F55D7448D','476','11');
Insert into SYSTEM.PRODUCTS1 (ID_PRODUCTS,NAME,REFERENCE,PRICE,CATEGORY_ID) values ('1250','ultrices','1F064187-E60B-C277-A1C6-1B9A7EDD2766','83','1');
Insert into SYSTEM.PRODUCTS1 (ID_PRODUCTS,NAME,REFERENCE,PRICE,CATEGORY_ID) values ('1500','pellentesque massa lobortis','27E82933-D7B2-EEE2-77EC-B0E74578AAF8','357','10');
Insert into SYSTEM.PRODUCTS1 (ID_PRODUCTS,NAME,REFERENCE,PRICE,CATEGORY_ID) values ('1505','placerat. Cras dictum','3D50E0E6-3F28-B41F-1B23-9A8BBE411A4D','963','7');
Insert into SYSTEM.PRODUCTS1 (ID_PRODUCTS,NAME,REFERENCE,PRICE,CATEGORY_ID) values ('1510','In mi','FE7EC113-8F46-1754-A075-0483B78FF9EF','93','3');
Insert into SYSTEM.PRODUCTS1 (ID_PRODUCTS,NAME,REFERENCE,PRICE,CATEGORY_ID) values ('1750','dui. Suspendisse ac','7CE26EA1-BC8C-86A4-10F4-80657AA76308','940','9');
Insert into SYSTEM.PRODUCTS1 (ID_PRODUCTS,NAME,REFERENCE,PRICE,CATEGORY_ID) values ('2000','sem egestas blandit.','D77ED537-85A4-B720-93CC-95D13D4E265A','386','6');
Insert into SYSTEM.PRODUCTS1 (ID_PRODUCTS,NAME,REFERENCE,PRICE,CATEGORY_ID) values ('2005','cursus','17B2A098-6E16-78EC-05E0-B27E5E2C5335','155','6');
Insert into SYSTEM.PRODUCTS1 (ID_PRODUCTS,NAME,REFERENCE,PRICE,CATEGORY_ID) values ('2010','eu arcu. Morbi','42296F37-56A3-25DB-4AA5-93DBD73DD387','378','11');
Insert into SYSTEM.PRODUCTS1 (ID_PRODUCTS,NAME,REFERENCE,PRICE,CATEGORY_ID) values ('2015','non dui nec','3B1CAA1E-C7C7-2DCE-D804-28E2F7E7435D','492','10');
Insert into SYSTEM.PRODUCTS1 (ID_PRODUCTS,NAME,REFERENCE,PRICE,CATEGORY_ID) values ('2020','Donec egestas.','C104EC22-53C5-965E-1D9C-21B05C934151','587','7');
Insert into SYSTEM.PRODUCTS1 (ID_PRODUCTS,NAME,REFERENCE,PRICE,CATEGORY_ID) values ('2025','adipiscing. Mauris','90B9DDAE-9927-01EB-10B5-825D173F7B8B','763','6');
Insert into SYSTEM.PRODUCTS1 (ID_PRODUCTS,NAME,REFERENCE,PRICE,CATEGORY_ID) values ('2030','Ut tincidunt','8D4B18FE-6408-EEBA-27DC-962D3F3E3001','244','4');
Insert into SYSTEM.PRODUCTS1 (ID_PRODUCTS,NAME,REFERENCE,PRICE,CATEGORY_ID) values ('2250','imperdiet ullamcorper.','1495257A-B908-A2CD-DAE2-8D90CC112835','154','1');
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.VEHI_CAMBIO
SET DEFINE OFF;
...
--------------------------------------------------------
  ...
  ;
--------------------------------------------------------
--  DDL for Index PK_TAB_PRODUCTS
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PK_TAB_PRODUCTS" ON "SYSTEM"."PRODUCTS" ("ID_PRODUCTS") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ;
--------------------------------------------------------
--  DDL for Index PK_FACTURAS_DETALLE
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PK_FACTURAS_DETALLE" ON "SYSTEM"."FACTURAS_DETALLE" ("ID") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."PK_CLIENTES" ON "SYSTEM"."CLIENTES" ("ID") 
  ;
--------------------------------------------------------
--  DDL for Index PK_COSTOEXTRA_FABRICANTE
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PK_COSTOEXTRA_FABRICANTE" ON "SYSTEM"."COSTOEXTRA_FABRICANTE" ("ID") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ;
--------------------------------------------------------
--  DDL for Index PK_EXTRAS
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PK_EXTRAS" ON "SYSTEM"."EXTRAS" ("ID") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."PK_FACTURAS" ON "SYSTEM"."FACTURAS" ("ID") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."PK_VEHICULOS" ON "SYSTEM"."VEHICULOS" ("ID") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."PK_VENDEDORES" ON "SYSTEM"."VENDEDORES" ("ID") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" ) ;
--------------------------------------------------------
--  DDL for Index PK_TAB_PRODUCTS1
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PK_TAB_PRODUCTS1" ON "SYSTEM"."PRODUCTS1" ("ID_PRODUCTS") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" ) ;
--------------------------------------------------------
--  DDL for Index PK_TAB_CATEGORIES1
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PK_TAB_CATEGORIES1" ON "SYSTEM"."CATEGORIES1" ("ID_CATEGORIES") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."PK_TAB_CATEGORIES" ON "SYSTEM"."CATEGORIES" ("ID_CATEGORIES") 
  ;
--------------------------------------------------------
--  DDL for Index PK_FABRICANTES
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PK_FABRICANTES" ON "SYSTEM"."FABRICANTES" ("ID") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ;
--------------------------------------------------------
--  DDL for Index PK_TAB_CATEGORIES11
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PK_TAB_CATEGORIES11" ON "SYSTEM"."CATEGORIES12" ("ID_CATEGORIES") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ;
--------------------------------------------------------
--  DDL for Index PK_VEHI_CAMBIO
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PK_VEHI_CAMBIO" ON "SYSTEM"."VEHI_CAMBIO" ("ID") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ;
--------------------------------------------------------
--  DDL for Index PK_TAB_ANSWERS
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PK_TAB_ANSWERS" ON "SYSTEM"."ANSWERS" ("ID_ANSWERS") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ;
--------------------------------------------------------
--  DDL for Index PK_COSTO_FABRICANTE
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PK_COSTO_FABRICANTE" ON "SYSTEM"."COSTO_FABRICANTE" ("ID") 
  ;
--------------------------------------------------------
...
/
--------------------------------------------------------
--  DDL for Procedure REORDENAR_UNIDADES_EXTRAS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."REORDENAR_UNIDADES_EXTRAS" AS
BEGIN
UPDATE Extras
...
/
--------------------------------------------------------
--  DDL for Function CELSIUS2FAHRENHEIT
--------------------------------------------------------

  CREATE OR REPLACE FUNCTION "SYSTEM"."CELSIUS2FAHRENHEIT" (C1 IN NUMBER)
RETURN NUMBER IS
  HI NUMBER :=0;
  BEGIN
    HI := C1*(9/5)+ 32;
  ...
  dbms_output.put_line( 'grados celsius son iguales a '||HI || ' grados fahrenheit');
  END;

/
--------------------------------------------------------
--  DDL for Function DECIMAL_BINARIO
--------------------------------------------------------

  CREATE OR REPLACE FUNCTION "SYSTEM"."DECIMAL_BINARIO" (C1 IN NUMBER)
RETURN VARCHAR IS
  cua INTEGER :=0;
  cadenaf VARCHAR:= '';
  --HI NUMBER :=0;
  BEGIN
    ...
    /*Imprmir la tabla del Resto desde el Final */
      while i >= 0 loop
        ...
        cadena := to_char(resto(i));
        cadenaf :=CONCAT(cadenaf,cadena);
        --dbms_output.put(resto(i)||rpad('	',1));
        i := i - 1;
      end loop;
      
      --dbms_output.put( 'El numero ' || n || ' en binario es ' || cadenaf);
  END IF;
    --HI := C1*(9/5)+ 32;
    RETURN cadenaf;
...
/
--------------------------------------------------------
--  DDL for Function FINDMAX
--------------------------------------------------------

  CREATE OR REPLACE FUNCTION "SYSTEM"."FINDMAX" (C1 IN number, C2 IN NUMBER)
RETURN NUMBER IS 
 z number:=0;
 hi number:=0;
 BEGIN
...
/
--------------------------------------------------------
--  DDL for Function FINDMIN
--------------------------------------------------------

  CREATE OR REPLACE FUNCTION "SYSTEM"."FINDMIN" (x IN number, y IN number)
RETURN number IS
  z number:=0;
  BEGIN
    IF X>Y then
...
/
--------------------------------------------------------
--  DDL for Function HELLO
--------------------------------------------------------

  CREATE OR REPLACE FUNCTION "SYSTEM"."HELLO" (C1 IN NUMBER)
RETURN NUMBER IS
  HI NUMBER;
  BEGIN
    HI := CELSIUS2FAHRENHEIT(20);
    RETURN HI;
  END;

/
--------------------------------------------------------
--  DDL for Function PRIMO
--------------------------------------------------------

  CREATE OR REPLACE FUNCTION "SYSTEM"."PRIMO" (N NUMBER)
  RETURN NUMBER;
  BEGIN
    FOR I IN 2..N-1 LOOP
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."REPCAT$_GROUPED_COLUMN" ADD CONSTRAINT "REPCAT$_GROUPED_COLUMN_PK" PRIMARY KEY ("SNAME", "ONAME", "GROUP_NAME", "COLUMN_NAME", "POS") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."PRODUCTS1" ADD CONSTRAINT "PK_TAB_PRODUCTS1" PRIMARY KEY ("ID_PRODUCTS") ENABLE;
  ALTER TABLE "SYSTEM"."PRODUCTS1" ADD CHECK (PRICE >0) ENABLE;
  ALTER TABLE "SYSTEM"."PRODUCTS1" MODIFY ("CATEGORY_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRODUCTS1" MODIFY ("PRICE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRODUCTS1" MODIFY ("REFERENCE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRODUCTS1" MODIFY ("NAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRODUCTS1" MODIFY ("ID_PRODUCTS" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table HUECOS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."HUECOS" ADD PRIMARY KEY ("ID") ENABLE;
--------------------------------------------------------
--  Constraints for Table LOGSTDBY$EDS_TABLES
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."LOGSTDBY$EDS_TABLES" ADD CONSTRAINT "LOGSTDBY$EDS_TABLES_PKEY" PRIMARY KEY ("OWNER", "TABLE_NAME") ENABLE;
--------------------------------------------------------
--  Constraints for Table REPCAT$_REPSCHEMA
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."REPCAT$_REPSCHEMA" ADD CONSTRAINT "REPCAT$_REPSCHEMA_PRIMARY" PRIMARY KEY ("SNAME", "DBLINK", "GOWNER") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."VEHICULOS" ADD CONSTRAINT "PK_VEHICULOS" PRIMARY KEY ("ID") ENABLE;
  ALTER TABLE "SYSTEM"."VEHICULOS" ADD CONSTRAINT "CK_ESTADO_VEHICULOS" CHECK (Estado in ('Nuevo', 'Usado')) ENABLE;
  ALTER TABLE "SYSTEM"."VEHICULOS" MODIFY ("ESTADO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."VEHICULOS" MODIFY ("ANO" NOT NULL ENABLE);
  ...
  ALTER TABLE "SYSTEM"."VEHICULOS" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."FABRICANTES" ADD CONSTRAINT "PK_FABRICANTES" PRIMARY KEY ("ID") ENABLE;
  ALTER TABLE "SYSTEM"."FABRICANTES" MODIFY ("TELEFONO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FABRICANTES" MODIFY ("DIRECCION" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FABRICANTES" MODIFY ("NOMBRE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FABRICANTES" MODIFY ("CEDULA_CIUDADANIA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FABRICANTES" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table CATEGORIES1
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."CATEGORIES1" ADD CONSTRAINT "PK_TAB_CATEGORIES1" PRIMARY KEY ("ID_CATEGORIES") ENABLE;
  ALTER TABLE "SYSTEM"."CATEGORIES1" ADD CHECK (SEASON IN ('WINTER','SUMMER','SPRING','AUTUMN')) ENABLE;
  ALTER TABLE "SYSTEM"."CATEGORIES1" MODIFY ("SEASON" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CATEGORIES1" MODIFY ("NAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CATEGORIES1" MODIFY ("ID_CATEGORIES" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table CATEGORIES12
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."CATEGORIES12" ADD CONSTRAINT "PK_TAB_CATEGORIES11" PRIMARY KEY ("ID_CATEGORIES") ENABLE;
  ALTER TABLE "SYSTEM"."CATEGORIES12" ADD CHECK (SEASON IN ('WINTER','SUMMER','SPRING','AUTUMN')) ENABLE;
  ALTER TABLE "SYSTEM"."CATEGORIES12" MODIFY ("SEASON" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CATEGORIES12" MODIFY ("NAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CATEGORIES12" MODIFY ("ID_CATEGORIES" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."PRODUCTS" ADD CONSTRAINT "PK_TAB_PRODUCTS" PRIMARY KEY ("ID_PRODUCTS") ENABLE;
  ALTER TABLE "SYSTEM"."PRODUCTS" MODIFY ("CATEGORY_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRODUCTS" MODIFY ("PRICE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRODUCTS" MODIFY ("REFERENCE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRODUCTS" MODIFY ("NAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRODUCTS" MODIFY ("ID_PRODUCTS" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table CATEGORIES
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."CATEGORIES" ADD CONSTRAINT "PK_TAB_CATEGORIES" PRIMARY KEY ("ID_CATEGORIES") ENABLE;
  ALTER TABLE "SYSTEM"."CATEGORIES" MODIFY ("SEASON" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CATEGORIES" MODIFY ("NAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CATEGORIES" MODIFY ("ID_CATEGORIES" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."DEF$_LOB" ADD CONSTRAINT "DEF$_LOB_PRIMARY" PRIMARY KEY ("ID") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."LOGMNR_UID$" ADD CONSTRAINT "LOGMNR_UID$_PK" PRIMARY KEY ("SESSION#") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."REPCAT$_KEY_COLUMNS" ADD CONSTRAINT "REPCAT$_KEY_COLUMNS_PRIMARY" PRIMARY KEY ("SNAME", "ONAME", "COL") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."ANSWERS" ADD CONSTRAINT "PK_TAB_ANSWERS" PRIMARY KEY ("ID_ANSWERS") ENABLE;
  ALTER TABLE "SYSTEM"."ANSWERS" MODIFY ("ANSWER" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ANSWERS" MODIFY ("NUMBER_OF_QUESTION" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ANSWERS" MODIFY ("ID_ANSWERS" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."DEF$_DEFAULTDEST" ADD CONSTRAINT "DEF$_DEFAULTDEST_PRIMARY" PRIMARY KEY ("DBLINK") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."REPCAT$_EXCEPTIONS" ADD CONSTRAINT "REPCAT$_EXCEPTIONS_PK" PRIMARY KEY ("EXCEPTION_ID") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."DEF$_ERROR" ADD CONSTRAINT "DEF$_ERROR_PRIMARY" PRIMARY KEY ("ENQ_TID") ENABLE;
--------------------------------------------------------
--  Constraints for Table FACTURAS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."FACTURAS" ADD CONSTRAINT "PK_FACTURAS" PRIMARY KEY ("ID") ENABLE;
  ALTER TABLE "SYSTEM"."FACTURAS" ADD CONSTRAINT "CK_ESTADO_FACTURAS" CHECK (Estado in ('Nuevo', 'Cambiado', 'Vendido')) ENABLE;
  ALTER TABLE "SYSTEM"."FACTURAS" MODIFY ("IDVENDEDOR" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FACTURAS" MODIFY ("IDCLIENTE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FACTURAS" MODIFY ("ESTADO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FACTURAS" MODIFY ("FECHA_VENTA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FACTURAS" MODIFY ("FECHA_COMPRA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FACTURAS" MODIFY ("VALOR_RESTANTE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FACTURAS" MODIFY ("TARIFAS_LICENCIA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FACTURAS" MODIFY ("IMPUESTOS" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FACTURAS" MODIFY ("FECHA_FACTURA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FACTURAS" MODIFY ("NUM_FACTURA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FACTURAS" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table FACTURAS_DETALLE
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."FACTURAS_DETALLE" ADD CONSTRAINT "PK_FACTURAS_DETALLE" PRIMARY KEY ("ID") ENABLE;
  ALTER TABLE "SYSTEM"."FACTURAS_DETALLE" MODIFY ("IDVEHICAMBIO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FACTURAS_DETALLE" MODIFY ("IDVEHICULO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FACTURAS_DETALLE" MODIFY ("FIRMA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FACTURAS_DETALLE" MODIFY ("COSTO_TOTAL" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FACTURAS_DETALLE" MODIFY ("IDEXTRA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FACTURAS_DETALLE" MODIFY ("IDFACTURA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FACTURAS_DETALLE" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table VEHI_CAMBIO
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."VEHI_CAMBIO" ADD CONSTRAINT "PK_VEHI_CAMBIO" PRIMARY KEY ("ID") ENABLE;
  ALTER TABLE "SYSTEM"."VEHI_CAMBIO" MODIFY ("COSTO_PERMITIDO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."VEHI_CAMBIO" MODIFY ("ANO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."VEHI_CAMBIO" MODIFY ("MODELO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."VEHI_CAMBIO" MODIFY ("HECHURA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."VEHI_CAMBIO" MODIFY ("NUM_SERIAL" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."VEHI_CAMBIO" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."LOGMNR_PROCESSED_LOG$" ADD CONSTRAINT "LOGMNR_PROCESSED_LOG$_PK" PRIMARY KEY ("SESSION#", "THREAD#") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."REPCAT$_INSTANTIATION_DDL" ADD CONSTRAINT "REPCAT$_INSTANTIATION_DDL_PK" PRIMARY KEY ("REFRESH_TEMPLATE_ID", "PHASE", "DDL_NUM") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."REPCAT$_RESOLUTION_METHOD" ADD CONSTRAINT "REPCAT$_RESOL_METHOD_PK" PRIMARY KEY ("CONFLICT_TYPE_ID", "METHOD_NAME") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."EXTRAS" ADD CONSTRAINT "PK_EXTRAS" PRIMARY KEY ("ID") ENABLE;
  ALTER TABLE "SYSTEM"."EXTRAS" MODIFY ("COSTO_VENTA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."EXTRAS" MODIFY ("DESCRIPCION" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."EXTRAS" MODIFY ("CODEXTRA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."EXTRAS" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."VENDEDORES" ADD CONSTRAINT "PK_VENDEDORES" PRIMARY KEY ("ID") ENABLE;
  ALTER TABLE "SYSTEM"."VENDEDORES" MODIFY ("TELEFONO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."VENDEDORES" MODIFY ("DIRECCION" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."VENDEDORES" MODIFY ("NOMBRE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."VENDEDORES" MODIFY ("CEDULA_CIUDADANIA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."VENDEDORES" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CLIENTES" ADD CONSTRAINT "PK_CLIENTES" PRIMARY KEY ("ID") ENABLE;
  ...
  ALTER TABLE "SYSTEM"."CLIENTES" MODIFY ("CEDULA_CIUDADANIA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CLIENTES" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table REPCAT$_OBJECT_TYPES
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."REPCAT$_OBJECT_TYPES" ADD CONSTRAINT "REPCAT$_OBJECT_TYPE_PK" PRIMARY KEY ("OBJECT_TYPE_ID") ENABLE;
--------------------------------------------------------
--  Constraints for Table COSTOEXTRA_FABRICANTE
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."COSTOEXTRA_FABRICANTE" ADD CONSTRAINT "PK_COSTOEXTRA_FABRICANTE" PRIMARY KEY ("ID") ENABLE;
  ALTER TABLE "SYSTEM"."COSTOEXTRA_FABRICANTE" MODIFY ("COSTO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."COSTOEXTRA_FABRICANTE" MODIFY ("IDFABRICANTE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."COSTOEXTRA_FABRICANTE" MODIFY ("IDEXTRA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."COSTOEXTRA_FABRICANTE" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table DEF$_CALLDEST
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."DEF$_CALLDEST" ADD CONSTRAINT "DEF$_CALLDEST_PRIMARY" PRIMARY KEY ("ENQ_TID", "DBLINK", "STEP_NO") ENABLE;
--------------------------------------------------------
--  Constraints for Table LOGMNR_AGE_SPILL$
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."LOGMNR_AGE_SPILL$" ADD CONSTRAINT "LOGMNR_AGE_SPILL$_PK" PRIMARY KEY ("SESSION#", "XIDUSN", "XIDSLT", "XIDSQN", "CHUNK", "SEQUENCE#") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table COSTO_FABRICANTE
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."COSTO_FABRICANTE" ADD CONSTRAINT "PK_COSTO_FABRICANTE" PRIMARY KEY ("ID") ENABLE;
  ALTER TABLE "SYSTEM"."COSTO_FABRICANTE" MODIFY ("COSTO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."COSTO_FABRICANTE" MODIFY ("IDFABRICANTE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."COSTO_FABRICANTE" MODIFY ("IDVEHICULO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."COSTO_FABRICANTE" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."REPCAT$_TEMPLATE_TYPES" ADD CONSTRAINT "REPCAT$_TEMPLATE_TYPES_PK" PRIMARY KEY ("TEMPLATE_TYPE_ID") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."ENCARGADOS" ADD PRIMARY KEY ("ID") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
--  Ref Constraints for Table COSTOEXTRA_FABRICANTE
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."COSTOEXTRA_FABRICANTE" ADD CONSTRAINT "FK_COSTOEXTRA_FAB_EXTRA" FOREIGN KEY ("IDEXTRA")
	  REFERENCES "SYSTEM"."EXTRAS" ("ID") ENABLE;
  ALTER TABLE "SYSTEM"."COSTOEXTRA_FABRICANTE" ADD CONSTRAINT "FK_COSTOEXTRA_FAB_FAB" FOREIGN KEY ("IDFABRICANTE")
	  REFERENCES "SYSTEM"."FABRICANTES" ("ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table COSTO_FABRICANTE
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."COSTO_FABRICANTE" ADD CONSTRAINT "FK_COSTO_FAB_FAB" FOREIGN KEY ("IDFABRICANTE")
	  REFERENCES "SYSTEM"."FABRICANTES" ("ID") ENABLE;
  ALTER TABLE "SYSTEM"."COSTO_FABRICANTE" ADD CONSTRAINT "FK_COSTO_FAB_VEH" FOREIGN KEY ("IDVEHICULO")
	  REFERENCES "SYSTEM"."VEHICULOS" ("ID") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."FACTURAS" ADD CONSTRAINT "FK_FACTURAS_CLIENTE" FOREIGN KEY ("IDCLIENTE")
	  REFERENCES "SYSTEM"."CLIENTES" ("ID") ENABLE;
  ALTER TABLE "SYSTEM"."FACTURAS" ADD CONSTRAINT "FK_FACTURAS_VENDEDOR" FOREIGN KEY ("IDVENDEDOR")
	  REFERENCES "SYSTEM"."VENDEDORES" ("ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table FACTURAS_DETALLE
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."FACTURAS_DETALLE" ADD CONSTRAINT "FK_FACTURAS_DETALLE_EXTRA" FOREIGN KEY ("IDEXTRA")
	  REFERENCES "SYSTEM"."EXTRAS" ("ID") ENABLE;
  ALTER TABLE "SYSTEM"."FACTURAS_DETALLE" ADD CONSTRAINT "FK_FACTURAS_DETALLE_FACTURA" FOREIGN KEY ("IDFACTURA")
	  REFERENCES "SYSTEM"."FACTURAS" ("ID") ENABLE;
  ALTER TABLE "SYSTEM"."FACTURAS_DETALLE" ADD CONSTRAINT "FK_FACTURAS_DET_IDVEHICAM" FOREIGN KEY ("IDVEHICAMBIO")
	  REFERENCES "SYSTEM"."VEHI_CAMBIO" ("ID") ENABLE;
  ALTER TABLE "SYSTEM"."FACTURAS_DETALLE" ADD CONSTRAINT "FK_FACTURAS_DET_VEH" FOREIGN KEY ("IDVEHICULO")
	  REFERENCES "SYSTEM"."VEHICULOS" ("ID") ENABLE;
--------------------------------------------------------
